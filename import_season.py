...
SEASON = [
    ...
    (9, "2026-06-26", "New Berlin Hills"),
    (10, "2026-07-03", "Dretzka"),
    (11, "2026-07-10", "Brookfield Hills"),
    (12, "2026-07-17", "Nagawaukee"),
    (13, "2026-07-24", "Western Lakes"),
    (14, "2026-07-31", "Greenfield"),
    (15, "2026-08-07", "Lincoln"),
...
COURSE_DATA = [
    ...
    {"name": "New Berlin Hills", "num_holes": 18, "total_par": 71,
     "pars": "5,4,4,4,4,4,3,4,4,4,4,3,5,4,3,4,4,4",
     "yardages": "519,291,361,346,322,400,158,371,327,400,382,173,495,384,173,346,308,386"},
]
